...
<body class="hold-transition login-page">
  ...
  <script>
    ...
    if (token) {
      ...
      console.log('Token stored:', token); // Debugging: Check if token is available
    }
  </script>
        ...
        <form action="/login" method="POST">
          ...
          <div class="d-flex justify-content-between align-items-center my-3">
            <div class="d-flex align-items-center">
              <input type="checkbox" class="mr-2" onclick="myFunction()" /> <label class="mb-0">Show Password</label>
            </div>
            <div>
